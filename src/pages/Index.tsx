...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 brown-gradient">
      <div className="max-w-3xl w-full text-center space-y-8 z-10">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold bg-gradient-to-r from-visa-gold to-white bg-clip-text text-transparent">
