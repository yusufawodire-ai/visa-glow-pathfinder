...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 bg-gradient-to-b from-visa-navy to-visa-dark-gray">
      <div className="max-w-3xl w-full text-center space-y-8">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold bg-gradient-to-r from-visa-gold to-visa-burgundy bg-clip-text text-transparent">
